...
class PlanesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plane" do
    assert_difference('Plane.count') do
      post planes_url, params: { plane: { plane_model_id: @plane.plane_model_id, xroute_id: @plane.xroute_id } }
    end
  ...
  test "should update plane" do
    patch plane_url(@plane), params: { plane: { plane_model_id: @plane.plane_model_id, xroute_id: @plane.xroute_id } }
